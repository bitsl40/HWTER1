...
### Задание 1 [Сылка на репазиторий с заданием 1 ](https://github.com/bitsl40/HWTER1/blob/main/task2/main.tf)


> 1. Перейдите в каталог . Скачайте все необходимые зависимости, использованные в проекте. 
